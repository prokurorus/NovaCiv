...
3. **Netlify environment variables** (for proxy function):
   ...
   - `VPS_ADMIN_DOMOVOY_URL` — VPS endpoint URL (e.g., `https://novaciv.space/api/domovoy` or `http://VPS_IP:3001/admin/domovoy`)
...
Then set in Netlify env: `VPS_ADMIN_DOMOVOY_URL=https://novaciv.space/api/domovoy`
